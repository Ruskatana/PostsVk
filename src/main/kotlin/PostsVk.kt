 ...
 class AudioAttachment (var id: Int = 0, var ownerId: Int = 0, var artist: String = "artist", var title: String = "name", var duration: Int = 0)
...
fun main() {
    val post1 = Post(2, 1, 5, 6, 6, "r", 6, 8, false, Comments(5,true,false,true,false), Copyright (5, "h", "f", "f"), canPin = true, canDelete = false, canEdit = true, isFavorite = true, Likes(5,true,false,true), true, false, Donut(true, 5), 5,)
